...
import static seedu.address.storage.travelplanner.JsonAdaptedTravelPlan.MISSING_FIELD_MESSAGE_FORMAT;
...
public class JsonAdaptedTravelPlanTest {
    ...
    private static final List<JsonAdaptedAccommodation> VALID_ACCOMMODATIONS = AUSTRALIA_TRIP.getAccommodationList().stream()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedTravelPlan travelPlan =
                new JsonAdaptedTravelPlan(INVALID_NAME, VALID_START_DATE, VALID_END_DATE, VALID_ACTIVITIES, VALID_ACCOMMODATIONS, VALID_FRIENDS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedTravelPlan travelPlan = new JsonAdaptedTravelPlan(null, VALID_START_DATE, VALID_END_DATE, VALID_ACTIVITIES, VALID_ACCOMMODATIONS, VALID_FRIENDS);
    ...
    public void toModelType_invalidStartDate_throwsIllegalValueException() {
        JsonAdaptedTravelPlan travelPlan =
                new JsonAdaptedTravelPlan(VALID_NAME, INVALID_START_DATE, VALID_END_DATE, VALID_ACTIVITIES, VALID_ACCOMMODATIONS, VALID_FRIENDS);
    ...
    public void toModelType_nullStartDate_throwsIllegalValueException() {
        JsonAdaptedTravelPlan travelPlan = new JsonAdaptedTravelPlan(VALID_NAME, null, VALID_END_DATE, VALID_ACTIVITIES, VALID_ACCOMMODATIONS, VALID_FRIENDS);
        String expectedMessage = String.format(JsonAdaptedTravelPlan.MISSING_FIELD_MESSAGE_FORMAT, WanderlustDate.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, travelPlan::toModelType);
    }
    ...
    public void toModelType_invalidEndDate_throwsIllegalValueException() {
        JsonAdaptedTravelPlan travelPlan =
                new JsonAdaptedTravelPlan(VALID_NAME, VALID_START_DATE, INVALID_END_DATE, VALID_ACTIVITIES, VALID_ACCOMMODATIONS, VALID_FRIENDS);
        String expectedMessage = WanderlustDate.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, travelPlan::toModelType);
    }
    ...
    public void toModelType_nullEndDate_throwsIllegalValueException() {
        JsonAdaptedTravelPlan travelPlan = new JsonAdaptedTravelPlan(VALID_NAME, VALID_START_DATE, null, VALID_ACTIVITIES, VALID_ACCOMMODATIONS, VALID_FRIENDS);
        String expectedMessage = String.format(JsonAdaptedTravelPlan.MISSING_FIELD_MESSAGE_FORMAT, WanderlustDate.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, travelPlan::toModelType);
    }
    ...
    public void toModelType_invalidActivities_throwsIllegalValueException() {
        ...
        invalidActivities.add(new JsonAdaptedActivity(INVALID_ACTIVITY_NAME, VALID_ACTIVITY_LOCATION, VALID_ACTIVITY_COST, VALID_ACTIVITY_IMPORTANCE, VALID_ACTIVITY_DATE_TIME));
        JsonAdaptedTravelPlan travelPlan =
                new JsonAdaptedTravelPlan(VALID_NAME, VALID_START_DATE, VALID_END_DATE, invalidActivities, VALID_ACCOMMODATIONS, VALID_FRIENDS);
    ...
    public void toModelType_invalidAccommodations_throwsIllegalValueException() {
        ...
        invalidAccommodations.add(new JsonAdaptedAccommodation(INVALID_ACCOMMODATION_NAME, VALID_ACCOMMODATION_START_DATE, VALID_ACCOMMODATION_END_DATE, VALID_ACCOMMODATION_COST, VALID_ACCOMMODATION_LOCATION));
        JsonAdaptedTravelPlan travelPlan =
                new JsonAdaptedTravelPlan(VALID_NAME, VALID_START_DATE, VALID_END_DATE, VALID_ACTIVITIES, invalidAccommodations, VALID_FRIENDS);
        assertThrows(IllegalValueException.class, travelPlan::toModelType);
    }
    ...
    public void toModelType_invalidFriends_throwsIllegalValueException() {
        ...
        JsonAdaptedTravelPlan travelPlan =
                new JsonAdaptedTravelPlan(VALID_NAME, VALID_START_DATE, VALID_END_DATE, VALID_ACTIVITIES, VALID_ACCOMMODATIONS, invalidFriends);
        assertThrows(IllegalValueException.class, travelPlan::toModelType);
    }
}
