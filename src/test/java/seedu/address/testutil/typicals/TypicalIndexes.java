...
public class TypicalIndexes {
    public static final Index INDEX_FIRST_PERSON = Index.fromOneBased(1); // TODO: change the variable name?
    ...
    public static final Index INDEX_TEN = Index.fromOneBased(10);
}
