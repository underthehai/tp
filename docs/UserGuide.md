...
------------ | ------------- | -------------
`n/NAME` | Name of the activity. | <ul><li>Should only contain alphanumeric characters, `,`, `'` and spaces</li><li>Should not be blank</li><li>Maximum size of 80 characters</li></ul>
`l/LOCATION` | Location/ Address of the activity | <ul><li>Can take any values</li><li>Should not be blank</li><li>Maximum size of 200 characters</li></ul>
